...
const CONFIG = {
    openTime: "11:00",
    closeTime: "23:59",
    whatsappNumber: "212770525156",
    estimatedPrepTime: "20-30", // minutes (range)
    restaurantLat: 33.8971,
...
const ADMIN_CONFIG = {
    ...
    sessionKey: "bocadillos_admin_session",
...
// ==========================================
const STORAGE_KEYS = {
    CART: 'bocadillos_cart',
    PIZZA_SIZES: 'bocadillos_pizza_sizes',
    PLAT_OPTIONS: 'bocadillos_plat_options',
    TABLE_SELECTION: 'bocadillos_table',
    ORDER_MODE: 'bocadillos_order_mode',
    ORDER_HISTORY: 'bocadillos_order_history'
};
...
function renderGrid(category) {
    ...
    items.forEach((item, index) => {
        ...
        // Stagger animation for premium entry feel
