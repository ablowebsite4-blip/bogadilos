// Service Worker for BOCADILLOS TANGERINO PWA
const CACHE_NAME = 'bocadillos-tangerino-v1';
const STATIC_ASSETS = [
  '/',
  '/index.html',
  '/styles.css',
  ...
  'https://fonts.googleapis.com/css2?family=Outfit:wght@400;500;600;700;800&family=Inter:wght@300;400;500;600;700;800&family=Poppins:wght@400;500;600;700&display=swap'
];
...
self.addEventListener('push', (event) => {
  if (event.data) {
    ...
    self.registration.showNotification('BOCADILLOS TANGERINO', {
      body: data,
